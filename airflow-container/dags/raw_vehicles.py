...
SQL_QUERY = '''SELECT id_veiculos, nome, tipo, valor, data_atualizacao, data_inclusao FROM public.veiculos;'''
...
DATASET = Dataset("/opt/airflow/data/vehicles/")
...
with DAG(
    dag_id="raw_vehicles2",
    description="copy vehicles table from database",
    schedule="@daily",
    default_args=DEFAULT_ARGUMENTS,
    start_date=pendulum.datetime(2026,1,1,tz="America/Sao_Paulo"),
    catchup=False,
    tags=["raw","postgre","vehicles","dimension", "full load"]
) as dag:
