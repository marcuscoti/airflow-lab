...
SQL_QUERY = '''SELECT id_clientes, cliente, endereco, id_concessionarias, data_inclusao, data_atualizacao FROM public.clientes;'''
...
DATASET = Dataset("/opt/airflow/data/clients/")
...
with DAG(
    ...
    catchup=False,
    tags=["raw","postgre","clients","dimension", "full load"]
) as dag:
