...
SQL_QUERY = '''SELECT id_concessionarias, concessionaria, id_cidades, data_inclusao, data_atualizacao FROM public.concessionarias;'''
...
DATASET = Dataset("/opt/airflow/data/stores/")
...
with DAG(
    dag_id="raw_stores",
    description="copy stores table from database",
    schedule="@daily",
    default_args=DEFAULT_ARGUMENTS,
    start_date=pendulum.datetime(2026,1,1,tz="America/Sao_Paulo"),
    catchup=False,
    tags=["raw","postgre","stores","dimension", "full load"]
) as dag:
